...
<html lang="en"><head>
  ...
  <tr>
    ...
    <tr>
      <td>Perihal</td>
      <td>:</td>
      <td><strong>Usulan PBI Non DTKS</strong></td>
      <td></td>
  ...
  <table class="alinea1">
    <tr>
      <td>
        Berdasarkan Surat Keputusan Menteri Sosial RI Nomor 21 Tahun 2019 tentang Persyaratan dan Tata Cara Perubahan Data PBI JK pasal 6 huruf (b) Peserta PBI JK yang dihapuskan, namun kemudian masih layak membutuhkan layanan kesehatan sebagaimana dimaksud pada ayat 7 diwajibkan melapor ke Dinas Sosial untuk mendapatkan surat keterangan reaktivasi.
      </td>
    </tr>
    <tr>
      <td style="text-indent: 0;">
        Sehubungan dengan hal tersebut, maka disampaikan bahwa:
      </td>
    </tr>
  </table>
  ...
  <table class="data-diri">
    <tr>
      <td>Nama</td>
      <td>:</td>
      <td><strong><?= $laporanById['nama']; ?></strong></td>
    </tr>
    <tr>
      <td>Jenis Kelamin</td>
      <td>:</td>
      <td><?= $laporanById['jenis_kelamin']; ?></td>
    </tr>
    <tr>
      <td width="170px">Tempat, Tanggal Lahir</td>
      <td width="10px">:</td>
      <td>
        <?= $laporanById['tempat_lahir'] . ', ' ?>
        <?php 
              $tanggal_lahir = strtotime($laporanById['tanggal_lahir']);
              setlocale(LC_TIME, 'id_ID');
              echo strftime('%d %B %Y', $tanggal_lahir);
        ?>
      </td>
    </tr>
    <tr>
      <td>Nomor Peserta</td>
      <td>:</td>
      <td><?= $laporanById['nomor_peserta']; ?></td>
    </tr>
    <tr>
      <td>NIK</td>
      <td>:</td>
      <td><?= $laporanById['nik']; ?></td>
    </tr>
    <tr>
      <td>No.KK</td>
      <td>:</td>
      <td><?= $laporanById['nomor_kk']; ?></td>
    </tr>
    <tr>
      <td>ID. DTKS</td>
      <td>:</td>
      <td><?= $laporanById['id_dtks']; ?></td>
    </tr>
    <tr>
      <td style="vertical-align: text-top;">Alamat Domisili</td>
      <td style="vertical-align: text-top;">:</td>
      <td style="vertical-align: text-top;"><?= $laporanById['alamat']; ?>, RT. <?= $laporanById['rt']; ?>/<?= $laporanById['rw']; ?></td>
    </tr>
    <tr>
      <td style="vertical-align: text-top;"></td>
      <td style="vertical-align: text-top;"></td>
      <td style="vertical-align: text-top;">Kel. <?= $laporanById['kelurahan']; ?> Kec. <?= $laporanById['kecamatan']; ?></td>
    </tr>
    <tr>
      <td style="vertical-align: text-top;"></td>
      <td style="vertical-align: text-top;"></td>
      <td style="vertical-align: text-top;">Kota Tangerang Selatan</td>
    </tr>
  </table>
  ...
  <table class="alinea2">
    <tr>
      <td style="text-indent: 0;">
        Merujuk pada Surat Keterangan Tidak Mampu dari Kelurahan <?= $laporanById['kelurahan']; ?>, <strong>Nomor: <?= $laporanById['nomor_surat']; ?></strong>, dan Data Terpadu Kesejahteraan Sosial (DTKS) Tahun <?= date('Y'); ?> (sedang dalam proses). Dengan ini kami mohon kepada Bapak/ibu untuk mengusulkan yang bersangkutan agar dapat mendapatkan BPJS JKN KIS PBI APBD Kota Tangerang Selatan.
      </td>
    </tr>
    <tr>
      <td style="padding-top: 15px;">
        Demikian Surat Rekomendasi ini dibuat agar dipergunakan sebagaimana mestinya. Atas perhatian dan kerjasamanya kami ucapkan terimakasih.
      </td>
    </tr>
  </table>
  ...
  <div class="pengesah" style="margin-left: 300px;">
    ...
    <div class="tembusan" style="padding-top: 51px; padding-left: 40px;">
      <p style="font-weight: 600; text-decoration: underline; font-size: 15px">Tembusan:</p>
      <p style="font-size: 15px;">Kepala Seksi Kesejahteraan Sosial Kelurahan <?= $laporanById['kelurahan']; ?></p>
    </div>
  </div>
</body></html>