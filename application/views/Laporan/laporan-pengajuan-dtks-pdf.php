...
<head>
  ...
  <title><?= isset($title) ? $title . ' ' . $laporanById['nama'] : 'Surat Pengajuan'; ?></title>
  <style>
    * {
      margin: 0;
      padding: 0;
  ...
  <div class="container">
    ...
    <div>
      <table class="heading">
        <tr>
          ...
          <th rowspan="2">
            <p>PEMERINTAH KOTA TANGERANG SELATAN <br>
              DINAS SOSIAL <br></p>
    ...
    <div>
      <table class="top">
        ...
        <tr>
          <td>Perihal</td>
          <td>:</td>
          <td><strong>Usulan PBI DTKS APBD</strong></td>
          <td></td>
    ...
    <div>
      <table class="alinea1">
        <tr>
          <td>
            <p>Berdasarkan Surat Keterangan Terdaftar Data Terpadu Kesejahteraan Sosial (DTKS) dari Sistem Informasi Kesejahteraan Sosial Next Generation Pusat Data dan Informasi Kementerian Sosial Republik Indonesia.</p>
          </td>
        </tr>
      </table>
    </div>
    ...
    <div>
      <table class="alinea2">
        <tr>
          <td>
            <p>Sehubungan yang bersangkutan Telah terdaftar dalam Basis Data Terpadu Kesejahteraan Sosial (DTKS) yang dibuktikan dengan Lampiran Surat Keterangan Terdaftar Data Terpadu Kesejahteraan Sosial (DTKS), Surat Rekomendasi ini dapat digunakan sebagai kelengkapan Syarat pengajuan Program.</p>
          </td>
        </tr>
        <tr>
          <td style="padding-top: 15px; text-indent: 0">
            <p>BPJS JKN KIS PBI (Penerima Bantuan Iuran) APBD Kota Tangerang Selatan.</p>
          </td>
        </tr>
        <tr>
          <td style="line-height: 2;">
            <p>Demikian Surat Rekomendasi ini dibuat agar menjadi maklum dan dapat dipergunakan sebagaimana mestinya, Atas perhatian dan kerjasamanya kami ucapkan terimakasih.</p>
          </td>
        </tr>
      </table>
    </div>
    <!-- AKHIR PARAGRAF KEDUA -->
